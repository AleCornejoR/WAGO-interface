...
class View(QWidget):
    ...
    def setup_home_tab(self):
        ...
        self.apply_text_box_styles(
            self.home_log_box, self.config["log_box"]["home"]["style"]["light"]
        )
    ...
    def setup_tester_tab(self):
        ...
        self.apply_text_box_styles(
            self.tester_log_box, self.config["log_box"]["tester"]["style"]["light"]
        )
    ...
    def setup_log_tab(self):
        ...
        self.apply_text_box_styles(
            self.log_log_box, self.config["log_box"]["log"]["style"]["light"]
        )
